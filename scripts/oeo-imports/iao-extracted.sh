...
java -jar robot.jar remove --input ${tmpdir}/iao-extracted.owl  --term http://purl.obolibrary.org/obo/IAO_0000013 --select "self" --exclude-term http://purl.obolibrary.org/obo/BFO_0000031 --output ${imports}/iao-extracted.ttl