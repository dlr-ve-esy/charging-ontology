...
java -jar robot.jar extract --input ${tmpdir}/oeo-physical.omn --method subset --term-file ${this_wd}/oeo_vehicle.txt --imports include --output ${tmpdir}/oeo_vehicle.ttl

java -jar robot.jar extract --input ${tmpdir}/oeo-physical.omn --method subset --term-file ${this_wd}/oeo_grid.txt --imports include --output ${tmpdir}/oeo_grid.ttl
