...
\begin{figure}[h]
    ...
    \centering
    \includesvg[width=0.8\textwidth]{images/OEOLVehicles}
\end{figure}

\begin{figure}[h]
    \caption{Common Core Ontologies Vehicle Taxonomy.}
    \centering
    \includesvg{images/CCOVehicles}
\end{figure}
...
\begin{figure}[h]
    ...
    \centering
    \includesvg{images/infrastructureSystem}
\end{figure}
...
\begin{figure}[h]
    ...
    \centering
    \includesvg[width=1.0\textwidth]{images/PARKING}
\end{figure}
